package com.mpush.tools.redis.manage;
...
public class RedisManage {
    ...
    private static final RedisRegister redisRegister = ServiceContainer.load(RedisRegister.class);
    ...
    public static void test(List<RedisGroup> groupList) {
