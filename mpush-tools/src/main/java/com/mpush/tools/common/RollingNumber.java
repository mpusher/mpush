...
public class RollingNumber {
     ...
     * @return
     *         value from the given {@link Event} counter type
     */
     ...
     * @return
     *         value from latest bucket for given {@link Event} counter type
     */
    ...
    public enum Event {
        ...
        FALLBACK_SUCCESS(1), FALLBACK_FAILURE(1), FALLBACK_REJECTION(1), FALLBACK_MISSING(1), EXCEPTION_THROWN(1), EMIT(1), FALLBACK_EMIT(1),
        THREAD_EXECUTION(1), COLLAPSED(1), RESPONSE_FROM_CACHE(1),
