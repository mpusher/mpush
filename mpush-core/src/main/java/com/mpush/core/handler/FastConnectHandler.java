...
public final class FastConnectHandler extends BaseMessageHandler<FastConnectMessage> {
    ...
    public void handle(FastConnectMessage message) {
        ...
        if (session == null) {
            ...
            Logs.CONN.warn("fast connect failure, session is expired, sessionId={}, deviceId={}, connection={}"
            ...
            Logs.CONN.warn("fast connect failure, not the same device, deviceId={}, session={}, connection={}"
